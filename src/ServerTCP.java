...
public class ServerTCP {
	...
	private synchronized boolean broadcast(String message) {
		...
		else
		{
			String messageLf = time + " " + message + "\n";
			// display message
			//return false;			// we loop in reverse order in case we would have to remove a Client
			...
			while(keepGoing) {
				...
				case ChatMessage.MESSAGE:
					...
					if(confirmation==false){
						String msg = notif + "Sorry.This user exists or specify the client your message needs to go to." + notif;
						writeMsg(msg);
					}
					break;
