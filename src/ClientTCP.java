...
public class ClientTCP {
   ...
   ClientTCP(String server, int port, String username) {
      this.server = server;
      this.port = port;
      this.username = username;
   }
   ...
   public static void main(String[] args) {
      ...
      int portNumber = 12050;
      String serverAddress = "196.42.126.145";
      ...
      System.out.println("1. Type '@username<space>yourmessage' without quotes to send message to desired client");
